...
public class StringServiceImpV1 implements StringService {
	 ...
	 * 1. 필드(멤버변수) 중에 객체들을 사용할 수 있도록 초기화, 생성 코드를 작성하는 영역.
	 * 
	 * 
	 */
	...
	public void input() {
		...
		//1. 생성할 배열의 크기를 먼저 설정한 후 각 요소의 값을 설정(할당)하는 방법
		...
		//2. 배열에 설정(할당)할 요소가 미리 정해진 경우 배열의 크기를 설정하지 않고 바로 요소를 나열하여
		//	 배열의 크기를 자동 설정한 후 요소를 설정(할당, 채워넣기)하는 방법
