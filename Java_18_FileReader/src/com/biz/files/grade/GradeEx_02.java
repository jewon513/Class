...
public class GradeEx_02 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 * FileGradeService.read() method가 실행 되는 중에 만약 문자열형 숫자를 숫자로 바꾸는 과정에서
			 * exception이 발생한다면 throw new NumberFormatException으로
			 * exception을 toss 하고 main에서는 해당 exception에 대해서 다른 exception과 처리를 분리할 수 있다.
			 */
